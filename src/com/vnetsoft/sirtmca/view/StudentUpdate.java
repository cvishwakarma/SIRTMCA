...
public class StudentUpdate extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// capture Student id from StudentDetails to load its data
	...
	private void CreateMenu(Menu menu) {
		MenuItem savestudent = menu.add(0,0,0,"update student");
		{

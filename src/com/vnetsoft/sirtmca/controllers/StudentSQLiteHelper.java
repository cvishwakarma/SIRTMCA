package com.vnetsoft.sirtmca.controllers;
...
public class StudentSQLiteHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		Log.e("STUDENTADO SQLITE HELPER","DB " + DB +" CREATED");
	    db.execSQL(CREATE_TABLE_STUDENTS);
	    Log.e("STUDENTADO SQLITE HELPER","TABLE " + TABLENAME +" CREATED");
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		onCreate(db);
		Log.e("STUDENTADO SQLITE HELPER","DB UPDATED!");
